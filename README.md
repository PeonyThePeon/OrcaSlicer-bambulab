...
In my opinion, distributing Bambu Studio as AGPL together with the closed `bambu_networking` component, without complete Corresponding Source under AGPL-compatible terms, violates the AGPL.
